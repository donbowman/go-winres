...
func Test_Patch(t *testing.T) {
	...
	main()
	checkFile(t, "temp.exe", []byte{0xb9, 0x10, 0xf8, 0x2b, 0x57, 0xb0, 0xc3, 0x54, 0xdd, 0x6d, 0x94, 0x5a, 0x82, 0xfb, 0xaa, 0xfd})
...
func Test_Patch_Add(t *testing.T) {
	...
	main()
	checkFile(t, "temp.exe", []byte{0xd3, 0x63, 0x6a, 0x64, 0x00, 0x5b, 0xb5, 0xb0, 0x05, 0xd4, 0xe1, 0x21, 0x36, 0xe8, 0x13, 0x7a})
...
func Test_Patch_Replace(t *testing.T) {
	...
	main()
	checkFile(t, "temp.exe", []byte{0x5f, 0x0c, 0x57, 0x9a, 0xcf, 0xd7, 0x84, 0x84, 0x0c, 0xa3, 0xe8, 0x89, 0x56, 0xc9, 0xad, 0x1d})
...
func Test_GitTag(t *testing.T) {
	...
	checkFile(t, "temp1.exe", []byte{0x0f, 0xbe, 0x6d, 0xb5, 0x47, 0x38, 0x8f, 0xe7, 0x75, 0xb6, 0x77, 0x1a, 0xbf, 0x94, 0xe6, 0xe7})
	checkFile(t, "temp2.exe", []byte{0xd8, 0xbc, 0x3a, 0x5b, 0x57, 0x9c, 0x5f, 0x00, 0xac, 0xe5, 0xde, 0xf2, 0x96, 0xf1, 0x08, 0x97})
}
...
func Test_SimplyGitTag(t *testing.T) {
	...
	checkFile(t, "rsrc_windows_amd64.syso", []byte{0x75, 0x9e, 0x6a, 0x5e, 0x17, 0xab, 0xfa, 0xda, 0x10, 0x1b, 0x5d, 0x70, 0xfa, 0xf6, 0xb2, 0x82})
	checkFile(t, "rsrc_windows_arm64.syso", []byte{0xe2, 0x70, 0x04, 0x0f, 0x45, 0x70, 0x0d, 0xf5, 0xb7, 0x8e, 0x5a, 0xc2, 0x3d, 0xcc, 0xbe, 0xb3})
}
...
func Test_Simply_PNGIcon(t *testing.T) {
	...
	main()
	checkFile(t, "rsrc.syso", []byte{0xbb, 0xbb, 0x78, 0x20, 0xe1, 0x80, 0x7b, 0x4c, 0xa8, 0x00, 0x1a, 0xa0, 0xa9, 0x8f, 0xe0, 0xfd})
}
...
func Test_Make(t *testing.T) {
	...
	main()
	checkFile(t, "make_windows_arm64.syso", []byte{0x1e, 0xdf, 0x7f, 0x3c, 0xbe, 0x8b, 0x55, 0x2f, 0x9b, 0xb7, 0xf3, 0x32, 0x06, 0xaf, 0x5b, 0xc7})
	checkFile(t, "make_windows_arm.syso", []byte{0x41, 0x8d, 0x9e, 0x2e, 0xf8, 0xd5, 0x37, 0x0b, 0x2f, 0x96, 0xa6, 0x5c, 0xda, 0x14, 0x61, 0x38})
	checkFile(t, "make_windows_amd64.syso", []byte{0x1c, 0xdf, 0xc4, 0xe6, 0x9e, 0x85, 0x21, 0xa0, 0xca, 0xf5, 0x8a, 0xa1, 0x61, 0x81, 0xf3, 0x45})
	checkFile(t, "make_windows_386.syso", []byte{0x07, 0x76, 0x86, 0xba, 0x49, 0xe3, 0x46, 0x81, 0x41, 0xbb, 0x62, 0x52, 0x5e, 0x2a, 0xf9, 0xa1})
}
